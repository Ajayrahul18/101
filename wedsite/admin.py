from flask import Blueprint, render_template, flash, send_from_directory, redirect, session, request
...
def add_best_sellers_items():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            flash(f'{product_name} added Successfully')
            print('Product Added')
            return redirect('/shop-bestselle')
        except Exception as e:
            print(e)
            flash('Product Not Added!!')
...
def add_get_bestoffers_items():
    ...
    if form.validate_on_submit():
        ...
        try:
            ...
            flash(f'{product_name} added Successfully')
            print('Product Added')
            return redirect('/shop-bestoffers')
        except Exception as e:
            print(e)
            flash('Product Not Added!!')
